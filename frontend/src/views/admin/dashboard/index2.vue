                        ...
                        <ul class="list-unstyled navbar__list">
                            <li class="active has-sub">
                                ...
                                <ul class="list-unstyled navbar__sub-list js-sub-list">
                                    <li>
                                        <a href="index1">
                                            <i class="fas fa-tachometer-alt"></i>Student Organization</a>
                                    </li>
                                    <li>
                                        <a href="index2">
                                            <i class="fas fa-tachometer-alt"></i>Job Placement</a>
                                    </li>
                                    <li>
                                        <a href="index3">
                                            <i class="fas fa-tachometer-alt"></i>Scholarship</a>
                                    </li>
                                    <li>
                                        <a href="index4">
                                            <i class="fas fa-tachometer-alt"></i>Student Discipline</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
